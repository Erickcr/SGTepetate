...
@section('contenido')
    ...
    <div class="mensaje">	
        <div class="encabezadoB"></div>
        <br>
        <p class="informacion">¡Algo salió mal!</p>
        <br>
        <img class="img_icon" src="img/imgPedido/bad.png">
        <br>
        <br>
        <a class="btn__submit" href="/solicitar-pedido" style="text-decoration: none;">REINTENTAR</a>
    </div>
